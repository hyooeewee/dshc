...
const PUBLIC_REPOSITORY_BLOB_ROOT = 'https://github.com/hyooeewee/dshc/blob/main/'
...
/** Whether an authored English source must carry a language switcher. dshc has no generated English docs. */
